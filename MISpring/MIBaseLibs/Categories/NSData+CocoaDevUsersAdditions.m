...
- (NSString*) base64Encode
{
	...
	NSInteger dataLength = (l - modulus);
...
- (NSString *)javaScriptStringEncodeWithCallback:(NSString *)callback
{
    ...
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\\" withString:@"\\\\"];
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\"" withString:@"\\\""];
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\'" withString:@"\\\'"];
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\n" withString:@"\\n"];
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\r" withString:@"\\r"];
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\f" withString:@"\\f"];
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\u2028" withString:@"\\u2028"];
    utf8String = [utf8String stringByReplacingOccurrencesOfString:@"\u2029" withString:@"\\u2029"];
    NSString *javaScript = [NSString stringWithFormat:@"%@('%@')", callback, utf8String];
    return javaScript;
}
