...
#define kDefaultBadgeBackgroundColor [MIUtility colorWithHex:0xffa000]

#define kDefaultBadgeTextFont [UIFont boldSystemFontOfSize:[UIFont systemFontSize]]

//边框颜色
#define kBadgeDefaultStrokeColor kDefaultBadgeBackgroundColor
#define kBadgeStrokeWidth 3.0f
...
#define kBadgeTextSideMargin 7.0f
...
{    
    ...
    self.badgeStrokeColor = kBadgeDefaultStrokeColor;
}
...
{    
    ...
    switch (self.badgeAlignment) {
        ...
        case JSBadgeViewAlignmentTopRight:
            ...
            newFrame.origin.y = -viewHeight / 3.0f;
            break;
