...
- (void)viewDidLoad
{
    ...
    //显示奖励到账信息
    awardBgView = [[UIView alloc] initWithFrame:CGRectMake(10, 10 + self.navigationBarHeight, SCREEN_WIDTH - 20, 55)];
    awardBgView.backgroundColor = [UIColor whiteColor];
    awardBgView.clipsToBounds = YES;
    awardBgView.layer.cornerRadius = 2.0;
    
    //登录信息
    UIView *awardInfoView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH - 20, 30)];
    ...
    _indicatorView.center = CGPointMake(150, 15);
    [_indicatorView startAnimating];
    [awardInfoView addSubview:_indicatorView];
    
    _totalAwardLabel = [[RTLabel alloc] initWithFrame:CGRectMake(0, 5, SCREEN_WIDTH - 20, 30)];
    ...
    _validAwardLabel = [[RTLabel alloc] initWithFrame:CGRectMake(0, 30, SCREEN_WIDTH - 20, 30)];
    ...
    UIView *splitLineView1 = [[UIView alloc] initWithFrame:CGRectMake(0, 30, SCREEN_WIDTH - 20, 1)];
    splitLineView1.backgroundColor = [MIUtility colorWithHex:0xf1f1f1];
    [awardBgView addSubview:splitLineView1];
    
    RTLabel *awardDetailsTips = [[RTLabel alloc] initWithFrame:CGRectMake(0, 35, SCREEN_WIDTH - 20, 25)];
    ...
    //分享链接
    shareToFriendsView = [[UIView alloc] initWithFrame:CGRectMake(10, awardBgView.bottom + 5, SCREEN_WIDTH - 20, 165)];
    shareToFriendsView.backgroundColor = [UIColor whiteColor];
    shareToFriendsView.layer.cornerRadius = 2.0;
    
    UIImageView *shareLinkView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH - 20, 45)];
    ...
    _shareLinkLabel = [[UILabel alloc] initWithFrame:CGRectMake(5, 0, SCREEN_WIDTH - 30, 45)];
    ...
    RTLabel *copyLinkTips = [[RTLabel alloc] initWithFrame:CGRectMake(5, shareLinkView.bottom, SCREEN_WIDTH - 30, 25)];
    ...
    UILabel *splitLineView2 = [[UILabel alloc] initWithFrame:CGRectMake(0, copyLinkTips.bottom - 5, SCREEN_WIDTH - 20, 1)];
    splitLineView2.backgroundColor = [MIUtility colorWithHex:0xf1f1f1];
    [shareToFriendsView addSubview:splitLineView2];
    
    UIButton *shareToWeixinBtn = [self buttonWithFrame:CGRectMake(10, splitLineView2.bottom + 10, 135, 36) iconName:@"ic_weixin" title:@"分享到微信"];
    ...
    UIButton *shareToQQBtn = [self buttonWithFrame:CGRectMake(155, splitLineView2.bottom + 10, 135, 36) iconName:@"ic_qq" title:@"分享给QQ好友"];
    ...
    UIButton *shareToQZoneBtn = [self buttonWithFrame:CGRectMake(10, shareToWeixinBtn.bottom + 10, 135, 36) iconName:@"ic_zone" title:@"分享到QQ空间"];
    ...
    UIButton *shareToWeiboBtn = [self buttonWithFrame:CGRectMake(155, shareToWeixinBtn.bottom + 10, 135, 36) iconName:@"ic_sina" title:@"分享到新浪微博"];
    ...
    //邀请规则信息
    awardRuleView = [[UIView alloc] initWithFrame:CGRectMake(10, shareToFriendsView.bottom + 5, SCREEN_WIDTH - 20, self.view.viewHeight - shareToFriendsView.bottom - 15)];
    awardRuleView.backgroundColor = [UIColor whiteColor];
    awardRuleView.layer.cornerRadius = 2.0;
    
    RTLabel *awardRuleTitle = [[RTLabel alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH - 20, 25)];
    ...
    UILabel *splitLineView3 = [[UILabel alloc] initWithFrame:CGRectMake(0, 25, SCREEN_WIDTH - 20, 1)];
    ...
    float imageViewHeiht = 290 * image.size.height / image.size.width;
    ...
    RTLabel *awardRuleTip = [[RTLabel alloc] initWithFrame:CGRectMake(10, awardRuleView.viewHeight - 35, SCREEN_WIDTH - 30, 35)];
